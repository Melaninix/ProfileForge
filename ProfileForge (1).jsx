...
export default function ProfileForge() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: bg, color: fg, fontFamily: "'Segoe UI', system-ui, sans-serif", transition: "background 0.3s" }}>
      {/* Top nav */}
      <div style={{ borderBottom: `1px solid ${border}`, background: panel, padding: `0 ${isMobile ? 16 : 24}px`, display: "flex", alignItems: "center", justifyContent: "space-between", height: 56, position: "sticky", top: 0, zIndex: 100 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: isMobile ? 4 : 8 }}>
          ...
          {["Form", "Template", "Preview"].map((s, i) => (
            <button key={i} onClick={() => setStep(i + 1)} style={{ padding: isMobile ? "5px 8px" : "5px 12px", borderRadius: 20, border: `1px solid ${step === i + 1 ? accent : border}`, background: step === i + 1 ? `${accent}22` : "transparent", color: step === i + 1 ? accent : muted, fontSize: isMobile ? 11 : 12, fontWeight: 600, cursor: "pointer", transition: "all 0.2s" }}>
              {isMobile ? `${i + 1}` : <><span style={{ opacity: step > i + 1 ? 0.5 : 1 }}>{i + 1}.</span> {s}</>}
            </button>
          ))}
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: isMobile ? "16px 12px" : "28px 24px" }}>
        ...
        {step === 2 && (
          <div>
            <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", alignItems: isMobile ? "flex-start" : "center", justifyContent: "space-between", marginBottom: 24, gap: isMobile ? 12 : 0 }}>
              <div>
                <h2 style={{ margin: "0 0 4px", fontSize: isMobile ? 18 : 22, fontWeight: 800, letterSpacing: "-0.03em" }}>Pick a template</h2>
            ...
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr 1fr" : isTablet ? "repeat(3, 1fr)" : "repeat(4, 1fr)", gap: isMobile ? 10 : 16, marginBottom: 28 }}>
              {TEMPLATES.map(t => (
            ...
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "260px 1fr", gap: 16, marginBottom: 20, alignItems: "start" }}>
              {/* Color Panel */}
              <div style={{ background: panel, borderRadius: 14, border: `1px solid ${border}`, padding: 18, position: isMobile ? "static" : "sticky", top: 72 }}>
        ...
        {step === 3 && (
          <div>
            <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", alignItems: isMobile ? "flex-start" : "center", justifyContent: "space-between", marginBottom: 20, gap: isMobile ? 12 : 0 }}>
              <div>
                <h2 style={{ margin: "0 0 4px", fontSize: isMobile ? 18 : 22, fontWeight: 800, letterSpacing: "-0.03em" }}>Your profile is ready ✨</h2>
            ...
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 260px", gap: 20, alignItems: "start" }}>
              {/* Profile display */}
              <div style={{ background: panel, borderRadius: 16, border: `1px solid ${border}`, overflow: "hidden", order: isMobile ? 2 : 1 }}>
                <div style={{ padding: "10px 16px", borderBottom: `1px solid ${border}`, display: "flex", alignItems: "center", gap: 8 }}>
                  <div style={{ width: 10, height: 10, borderRadius: "50%", background: "#ef4444" }} />
                  <div style={{ width: 10, height: 10, borderRadius: "50%", background: "#f59e0b" }} />
                  <div style={{ width: 10, height: 10, borderRadius: "50%", background: "#22c55e" }} />
              ...
              {/* Actions sidebar */}
              <div style={{ display: "flex", flexDirection: "column", gap: 10, order: isMobile ? 1 : 2 }}>
